...
\begin{description}
    \item[Definition] The order statistics $X_{(1)}, X_{(2)}, \dots, X_{(n)}$ of a set of random variables $X_{1}, X_{2}, \dots, X_{n}$ are defined such that $X_{(i)}$ is the $i$th smallest of the $X_i$.
